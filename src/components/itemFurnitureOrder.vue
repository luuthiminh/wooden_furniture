          ...
          <div class="text-sm flex flex-cols-2">
              ...
              <template v-slot:body>
                <div class="w-full items-center gap-x-6 pb-3">
                  <label
                    ...
                    class="font-semibold text-yellow-950"
                    >Picture</label
                  >
                  <input
                    id="picture"
                ...
                <div class="mt-3">
                  <label class="col-form-label font-semibold text-yellow-950"
                    >Warranty Reasons
                  </label>
                  <div class="">
                    <input
            ...
            >
              ...
              <template v-slot:body>
                ...
                >
                  <label class="text-sm font-semibold text-yellow-950"
                    >Content</label
                  >
                  <textarea
                    v-model="content"
                ...
                <div class="bg-white flex gap-2 rounded-xl p-2 text-sm mt-3">
                  <label class="font-semibold text-yellow-950 text-sm"
                    >Vote Star</label
                  >
                  <div class="rating">
                    <input
